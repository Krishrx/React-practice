    ...
    if (type === 'checkbox') {
        return (
            <div className='space-x-4 flex justify-center items-center'>
                <input type='checkbox' name={name} id={name} className={style} onChange={fn} />
        ...
        return (
            <div className='space-x-4 flex justify-center items-center'>
                <label htmlFor={name}>{displayText}</label>
                <select className={style} name={name} id={name} value={value} onChange={fn}>
                    {selectOptions}
                </select>    
            </div> 
        )
        ...
        return (
            <div className='space-x-4 flex justify-center items-center'>
                <label htmlFor={name}>{displayText}</label>
                <input type={type} id={name} name={name} className={style} onChange={fn} />
            </div>
        )
    }
}

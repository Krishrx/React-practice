...
function Card({load}) {
  ...
  return (
    <div className='max-w-[500px] h-full relative pb-14'>
        <img src={image} alt="person" className='w-20 h-20 rounded-full absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2'/>

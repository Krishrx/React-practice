...
<div className="h-screen w-full bg-gray-50 flex items-center">
    <div className="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700">
          ...
          <Link className="px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-orange-600 active:bg-red-600 hover:bg-orange-700" to={'/'}>Back to homepage</Link>
    </div>
